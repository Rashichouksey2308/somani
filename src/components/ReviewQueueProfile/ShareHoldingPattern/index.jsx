...
function Index({ shareHolding }) {
  ...
  const equityCapital = () => {
    const values = shareHolding?.filter((item) => {
                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{totalPrefrenceSharePercentage ? Number(totalPrefrenceSharePercentage * 100).toFixed(2) + '%' : ''}</td>
                        <td className="border-top-0"></td>
                        <td className="border-top-0"></td>
                      </tr>
                    </tbody>
