        ...
        <div className={styles.main}>
            ...
            <div className={`${styles.input_container} row align-items-center`}>
                <div className={`${styles.each_input} col-md-4 col-sm-6`}>
                    <label className={styles.label_heading} id="dropDoc">Type Of Document</label>
                ...
                <div className={`${styles.each_input} col-md-4 col-sm-6`}>
                    <label className={styles.label_heading}>Attach Document</label>
                    <div className={styles.certificate}>Incorporation_Certification267576332.pdf
                        <img className={`${styles.close_image} img-fluid`} src="/static/close.svg" alt="Close" />
                    </div>
                </div>
                <div className={`${styles.each_input} col-md-4 col-sm-6`}>
                    <label className={styles.label_heading}>Action</label>
                    <div className={styles.image_card}>
                        <img className={`${styles.image_delete} img-fluid`} src="/static/delete.svg" />
                    </div>
                </div>
