        ...
        <div className={`${styles.main} mt-4 card border_color`}>
            ...
            >
                ...
                <div className='d-flex'>
                    <p className='font-weight-bold label_heading mr-4'>Plot Inspection Date: <p className='d-inline-block text-dark'>{plotInspection?.plotInspectionDate.slice(0, 10)}</p></p>
                    <span>+</span>
                </div>
            </div>
            <div id="plotInspection" className="collapse" aria-labelledby="plotInspection">
                <div className={`${styles.dashboard_form} vessel_card card-body p-0`}>
                    <div className="d-flex justify-content-between my-auto flex-column">
                        {plotInspection?.plotInspectionReport && <Documents plotInspectionReport={[plotInspection?.plotInspectionReport]} />}
                    </div>
                </div>
            </div>
        </div>
