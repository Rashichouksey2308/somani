  ...
  return (
    <div className={`${styles.cardBody} card-body pt-3`}>
      ...
      <p className="text_sales">
        ...
        at <b>{data.buyerAddress}</b> through its Authorised Signatory (hereinafter referred as the “
        <b>{data.buyerseller}</b> ”, which expression shall, unless excluded by or repugnant to the context be deemed to
