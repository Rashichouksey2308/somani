        ...
        <tr>
          <td valign='top' style={{padding:'20px'}}>
            <table width='100%' cellPadding='0' cellSpacing='0' border='0'>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}><strong>FOR RECEIPT, STORAGE, CUSTODY AND ISSUE OF PLEDGED GOODS</strong> hereto by and between:</p></td>
              </tr>
              <tr>
                <td align='justify'>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>                    
                    ...
                    1956, having its <strong>registered office</strong> at <strong>{data.buyerAddress}</strong>
              ...
              <tr>
                <td align='center'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>And</p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.seller}</strong>(hereinafter referred as the <strong>“IIAG”</strong>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.shortseller}</strong> is engaged in the business of trading of
                    industrial commodities, which are stored at the Designated Storage Area
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong> has purchased Commodity from the Supplier,
                    that has been financed by the “Financing Bank”. The details of the
                    commodity purchased, Supplier and the Financing Bank are mentioned in
                    Schedule-I.
                  </p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    ...
                    <strong>{data.shortseller}</strong> , Collateral Manager and Financing Bank as
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong>hereby agrees that it shall grant unrestricted
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>IT IS HEREBY AGREED AS FOLLOWS:</p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong>hereby grants unrestricted access of the
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    ...
                    Manager and held on behalf of <strong>{data?.shortseller}</strong>
                  </p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    ...
                    specifying the name of <strong>{data?.shortseller}</strong> as the owner of the
                    Goods and Collateral Manager as the Collateral Manager as custodian of
                    the Goods;
                  </p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    ...
                    also be borne by <strong>{data.buyerseller}</strong>. Collateral Manager and their
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <span className="mr-6">2.7</span> ensure that the Designated Storage
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <span className="mr-6">2.8</span> be responsible for payment of all
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>Collateral Manager shall:</p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    ...
                    and Collateral Manager for a period during which the Collateral
                    Management Agreement, pursuant to which Collateral Manager is providing
                    the collateral management services (“<strong>CMA Services</strong>”), is
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <span className="mr-6">5.2</span> <strong>{data.shortbuyer}</strong> undertakes
                    that the pledged Goods shall be separately stocked at the Designated
                    Storage Area under the custody and control of Collateral Manager
                  </p></td>
              </tr>
              <tr>
                <td align='justify'>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <span className="mr-6">7.1</span> <strong>{data.buyerseller}</strong> shall take
                    ...
                    been released by Collateral Manager to <strong>{data.buyerseller}</strong>. The
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong> shall be responsible for the payment of all
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    During the period of this Agreement, <strong>{data.buyerseller}</strong> shall be
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong> shall bear all duties, taxes, cesses, levies
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong>hereby agrees to make the payments referred
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong> will pay any deposits due in respect of water
                    and electricity charges as may be required. <strong>{data.buyerseller}</strong>
              ...
              <tr>
                <td align='justify'>
                  ...
                  <ul style={{fontSize:'12px', lineHeight:'18px', color:'#000000', paddingLeft:'20px'}}>
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> shall arrange to obtain no claim on
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong>shall furnish written confirmation to
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        During the period of this Agreement, <strong>{data.buyerseller}</strong> shall
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> further agrees that he shall not, for any
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> hereby waives all rights to the Goods
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> shall take the delivery of the Goods from
                        ...
                        Collateral Manager on instructions of <strong>{data?.shortseller}</strong>
                      </p>
                    </li>
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> warrants that Collateral Manager shall
                  ...
                  <ul style={{fontSize:'12px', lineHeight:'18px', color:'#000000', paddingLeft:'20px'}}>
                    ...
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        ...
                        from <strong>{data.buyerseller}</strong> or any person claiming under it.
                      </p>
                    </li>
                  </ul></td>
              </tr>
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    <strong>{data.buyerseller}</strong> agrees to indemnify and keep indemnified,
                    defend and hold harmless Collateral Manager and
                    <strong>{data.buyerseller}</strong>, its officers, directors, employees and agents
                    from and against any and all losses, liabilities, claims, obligations,
                    costs, expenses arising during the duration of this Agreement, which
                    result from, arise in connection with or are related in any way to
                    claims by third parties or regulatory authorities, and which directly
                    arise due to any reasons whatsoever and including the following
                  </p></td>
              </tr>
              <tr>
                <td align='justify'>
                  <ol type="i" style={{fontSize:'12px', lineHeight:'18px', color:'#000000', paddingLeft:'20px'}}>
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        <strong>{data.buyerseller}</strong> 's breach of the terms of this Agreement
                        or;
                      </p>
                    </li>
                    <li>
                      <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                        negligence, fault or misconduct by <strong>{data.buyerseller}</strong> or its
              ...
              <tr>
                <td align='justify'>
                  <p style={{fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
                    The responsibility of <strong>{data.buyerseller}</strong> to indemnify set forth
                    in this Clause and the obligations there under, shall survive the
                ...
                <td style={{paddingTop:'20px'}}>
                  ...
                  >
                    ...
                    <tr>
                      ...
                      >
                        <p style={{fontSize:'12px', lineHeight:'18px', color: '#000000', marginBottom: '0'}}>Designated Storage Area</p>
                      </td>
                      <td
                        style={{
                          borderBottom: '1px solid #000000',
                    ...
                    <tr>
                      ...
                      >
                        <p style={{fontSize:'12px', lineHeight:'18px', color: '#000000', marginBottom: '0'}}>Name of Supplier</p>
                      </td>
                      <td
                        style={{
                          borderBottom: '1px solid #000000',
              ...
              <tr>
                <td valign='top' style={{paddingTop:'30px'}}>
                  <table width="100%" cellPadding="0" cellSpacing="0" border="0">
                    <tr>
                      <td colSpan={2} align='left'><p style={{fontSize:'12px', lineHeight:'18px', color: '#000000'}}><strong>SIGNATURE PAGE</strong></p></td>
                    </tr>
                    <tr>
                      <td align='center' width='50%'><p style={{fontSize:'12px', lineHeight:'18px', color: '#000000'}}>Buyer</p></td>
                      <td align='center' width='50%'><p style={{fontSize:'12px', lineHeight:'18px', color: '#000000'}}>Supplier</p></td>
                    </tr>
                    <tr>
  ...
  return (
    <div className={`${styles.cardBody} card-body pt-3`}>
      ...
      <p className="text_sales">
        ...
        1956, having its <b>registered office</b> at <b>{data.buyerAddress}</b>{' '}
        through its Authorised Signatory (hereinafter referred as the “
      ...
      <p className="text-center text_sales">And</p>
      <p className="text_sales">
        <b>{data.seller}</b>(hereinafter referred as the <strong>“IIAG”</strong>
        , which expression shall, unless excluded by or repugnant to the context
        be deemed to include its legal heirs, successors and permitted assigns)
        of the Third Part.
      </p>
      ...
      <p className="text_sales">
        <b>{data.shortseller}</b> is engaged in the business of trading of
        industrial commodities, which are stored at the Designated Storage Area
        as detailed in Schedule-I.
      </p>
      <p className="text_sales">
        <b>{data.buyerseller}</b> has purchased Commodity from the Supplier,
        that has been financed by the “Financing Bank”. The details of the
        commodity purchased, Supplier and the Financing Bank are mentioned in
        Schedule-I.
      </p>
      <p className="text_sales">
        ...
        form of a pledge, and has appointed Collateral Manager pursuant to the
        terms of the tripartite collateral management agreement executed between{' '}
        <b>{data.shortseller}</b> , Collateral Manager and Financing Bank as
        amended from time to time (the “
        <strong>Collateral Management Agreement</strong>”) for the purpose of
        keeping the custody and control of Goods.
      </p>
      ...
      <p className="text_sales">
        <b>{data.buyerseller}</b>hereby agrees that it shall grant unrestricted
        access to a clearly demarcated part of the Storage Facility (as per
        stocking requirement) in ready-to-operate-condition exclusively for the
        use of Collateral Manager where the pledged Goods shall only be stored
        (the “<strong>Designated Storage Area</strong>”).
      ...
      <p className=" text_sales">
        <b>{data.buyerseller}</b>hereby grants unrestricted access of the
        Designated Storage Area to Collateral Manager, which is in a ready to
        store condition. The Plan duly marking the Designated Storage Area is
        attached Schedule 1 to this Agreement. The Goods deposited in the
        Designated Storage Area shall be accessed exclusively by Collateral
      ...
      <p className=" text_sales">
        ...
        displaying on the board at the entrance of the Designated Storage Area
        clearly stating that the Goods are under the custody of Collateral
        Manager and held on behalf of <b>{data?.shortseller}</b>{' '}
      </p>
      <p className=" text_sales">
        <span className="mr-6">2.3</span> be responsible for putting a Placard
        on each lot of Goods stored at the Designated Storage Area clearly
        specifying the name of <b>{data?.shortseller}</b> as the owner of the
        Goods and Collateral Manager as the Collateral Manager as custodian of
        the Goods;{' '}
      </p>
      <p className=" text_sales">
        ...
        telephone, access to fax, email etc. will have to be provided free of
        cost to Collateral Manager and the running cost of these facilities will
        also be borne by <b>{data.buyerseller}</b>. Collateral Manager and their
        representatives shall have unfettered access to the warehouse/stockyard;{' '}
      </p>
      <p className=" text_sales">
        <span className="mr-6">2.5</span> be responsible for granting
      ...
      <p className=" text_sales">
        <span className="mr-6">5.2</span> <b>{data.shortbuyer}</b> undertakes
        that the pledged Goods shall be separately stocked at the Designated
        Storage Area under the custody and control of Collateral Manager{' '}
      </p>
      ...
      <p className=" text_sales">
        <span className="mr-6">7.1</span> <b>{data.buyerseller}</b> shall take
        out and maintain an all risks cargo insurance policy in respect of the
        Goods which terms are acceptable to the respective Financing Bank at its
        full discretion. The policy shall cover loss, strikes, riots, civil
        commotion, theft, misappropriation and damage of the Goods during
        ...
        from the Designated Storage Area. The Insurance shall remain valid until
        the period that the entire Goods at the Designated Storage Area have
        been released by Collateral Manager to <b>{data.buyerseller}</b>. The
        insurance policy shall name the Financing Bank as a beneficiary of
        insurances and loss payee.
      </p>
      <p className=" text_sales">
        <span className="mr-6">7.2</span> Upon request <b>{data.buyerseller}</b>{' '}
        will deliver to Collateral Manager and IIAG a copy of the relevant
        insurance agreements, policies and related documents together with
        evidence that the premiums have been paid.
      </p>
      ...
      <p className=" text_sales">
        <b>{data.buyerseller}</b> shall be responsible for the payment of all
        Land and Building taxes as may be applicable and that relate to the
        Designated Storage Area.
      </p>
      ...
      <p className=" text_sales">
        During the period of this Agreement, <b>{data.buyerseller}</b> shall be
        responsible for payment of all charges with regard to water and
        electricity.
      </p>
      <p className=" text_sales">
      ...
      <p className=" text_sales">
        <b>{data.buyerseller}</b> shall bear all duties, taxes, cesses, levies
        etc. payable under present Indian State/Central Government/Semi
        Government Policies or payable in future under any newly implemented
        Government Policy/ies in respect of the said Designated Storage Area
      </p>
      <p className=" text_sales">
        <b>{data.buyerseller}</b>hereby agrees to make the payments referred
        above regularly without any delay and default and shall produce to
        Collateral Manager, after expiry of every 12 months, certified copies of
        the receipts for the payments made during such period.
      </p>
      ...
      <p className=" text_sales">
        <b>{data.buyerseller}</b> will pay any deposits due in respect of water
        and electricity charges as may be required. <b>{data.buyerseller}</b>{' '}
        hereby indemnifies Collateral Manager against any consequences that may
        arise as a result of failure to pay said deposits or any claims
        whatsoever with regards to any of the charges.
      </p>
      ...
      <ul className="pl-4">
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> shall arrange to obtain no claim on
            inventory letters from all and any party who has an interest in the
            Storage Facility/Designated Storage Area. Such letters shall
            proclaim that the parties concerned recognize and agree that they do
            not have any ownership or title rights to the Goods stored at the
        ...
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b>shall furnish written confirmation to
            Collateral Manager that there are no circumstances of which he is
            aware that may give rise to a claim over the land, plot, Designated
            Storage Area or the Goods stored therein during the period of this
            Agreement.
        ...
        <li>
          <p className=" text_sales">
            During the period of this Agreement, <b>{data.buyerseller}</b> shall
            warrant that it will allow Collateral Manager to have the custody,
            control and supervision of the Goods stored at the Designated
            Storage Area without any interruption and obstruction
          </p>
        ...
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> further agrees that he shall not, for any
            reason whatsoever, prevent Collateral Manager from entering or
            leaving the Designated Storage Area nor shall it at any time prevent
            Collateral Manager from taking in, or delivering out, the Goods
            stored therein which shall be done under the supervision of
        ...
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> hereby waives all rights to the Goods
            stored under the custody of Collateral Manager and shall not remove,
            transfer or otherwise attempt to gain control of the Goods unless
            authorized in writing by Collateral Manager .
          </p>
        ...
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> shall take the delivery of the Goods from
            Collateral Manager only upon receipt [by Collateral Manager] of the
            Release Orders from the Financing Bank and then released by
            Collateral Manager on instructions of <b>{data?.shortseller}</b>
          </p>
        </li>
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> warrants that Collateral Manager shall
            enjoy complete and uninterrupted custody of the Goods in the
            Designated Storage Area
          </p>
        </li>
      ...
      <ul className="pl-4">
        ...
        <li>
          <p className=" text_sales">
            ...
            access of the Designated Storage Area during the term or duration of
            this Agreement, without disturbance or interruption or obstruction
            from <b>{data.buyerseller}</b> or any person claiming under it.
          </p>
        </li>
      </ul>
      ...
      <p className=" text_sales">
        <b>{data.buyerseller}</b> agrees to indemnify and keep indemnified,
        defend and hold harmless Collateral Manager and{' '}
        <b>{data.buyerseller}</b>, its officers, directors, employees and agents
        from and against any and all losses, liabilities, claims, obligations,
        costs, expenses arising during the duration of this Agreement, which
        result from, arise in connection with or are related in any way to
        claims by third parties or regulatory authorities, and which directly
      ...
      <ol type="i" className="pl-4">
        <li>
          <p className=" text_sales">
            <b>{data.buyerseller}</b> 's breach of the terms of this Agreement
            or;
          </p>
        </li>
        <li>
          <p className=" text_sales">
            negligence, fault or misconduct by <b>{data.buyerseller}</b> or its
            officers, employees, agents, subcontractors and/or representatives
            and/or other persons authorized to act on its behalf;
          </p>
        </li>
      ...
      <p className=" text_sales">
        The responsibility of <b>{data.buyerseller}</b> to indemnify set forth
        in this Clause and the obligations there under, shall survive the
        termination of this Tripartite Agreement for any reason whatsoever with
        regard to any indemnity claims arising out of or in relation to the
        performance hereof.
