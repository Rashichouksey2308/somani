                            ...
                            <div className={`${styles.form_group} mt-5  col-md-6`} >
                                ...
                                <div className={`${styles.checkbox_container} label_heading d-flex flex-column`}>
                                    ...
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.royalyAndPenaltyCharges} />
                                        <label className={styles.checkbox_label}>Wharfage Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.pollutionCharges} />
                                    ...
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.tarpaulinCoverageCharges} />
                                        <label className={styles.checkbox_label}>Tarpaulin Coverage Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.wheighmentAndWeighmentSurveyCharges} />
                                        <label className={styles.checkbox_label}>Wheighment &amp; Weighment Survey Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.draughtSurveyCharges} />
                                        <label className={styles.checkbox_label}>Draught Survey Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.boatingWhileDraughtSurveyCharges} />
                                        <label className={styles.checkbox_label}>Boating while Draught Survey Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.hmcCharges} />
                                        <label className={styles.checkbox_label}>HMC Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.securityCharges} />
                                        <label className={styles.checkbox_label}>Security Charges</label>
                                    </div>
                                    <div className='pt-4 d-flex align-items-center'>
                                        <input className={styles.checkbox} type="checkbox" checked={data.chaOrstevedoringCharges.piotRentalAndStorageCharges} />
