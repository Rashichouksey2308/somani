                                ...
                                <div className=''>
                                    ...
                                    <div className={`${styles.checkbox_container}  label_heading d-flex flex-column`}>
                                        ...
                                        <div className='d-flex align-items-center'>
                                            ...
                                            <label className={`${styles.checkbox_label} termsheet_Text`}>LC Opening Charges ( on LC value subject to minimum of <input disabled type="text" style={{padding:'0px' , width:'115px'}} className={`${styles.igpl_para} ${styles.input} input`} placeholder={`${'USD'} ${_get(termsheetDetails, 'commercials.lcOpeningChargesUnit', '1500').toLocaleString('en-In')}`} />)</label>
                                        </div>
                                        <div className='pt-4 d-flex align-items-center'>
