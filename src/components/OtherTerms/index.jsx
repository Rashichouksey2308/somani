        ...
        <div className={styles.dashboard_form}>
            ...
            <div className='row'>
               <div className={`${styles.terms_para}`}>
                ...
                <span className={styles.igpl_para}>Indo German International Private Limites (Igpl) </span> 
                ...
                <div className={`${styles.terms_para} pt-3`}>All necessary documents to be filed with Customs department for discharge of goods & Customs clearance can be filed by 
