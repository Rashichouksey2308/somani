  ...
  return (
    ...
    <div  className={`${styles.term_container} mb-3 mt-3 container-fluid`}>
       ...
       <div className='d-flex justify-content-between'>
        ...
        <div>
            <div className={styles.sub_heading}>Documentary Credit Number: <span>ABSD123456</span></div>
            <div className={styles.sub_heading}>Date: <span>16.02.2022</span></div>
        </div>
        </div>    
        </div>
        ...
        <Card className={styles.content}>
           <div className={`${styles.datatable} datatable `}>
            ...
            <tr className="table_row">
                <td width='40%' >40A &nbsp; &nbsp; <span>FORM OF DOCUMENTARY CREDIT</span></td>
                <td>IRREVOCABLE</td>
              </tr>
               <tr className="table_row">
                <td width='40%' >40E &nbsp; &nbsp; <span>APPLICABLE RULES</span></td>
                <td>UCP LATEST VERSION</td>
              </tr>
               <tr className="table_row">
                <td width='40%' >31D &nbsp; &nbsp; <span>DATE OF EXPIRY</span></td>
                <td>22.02.2022</td>
              </tr>
               <tr className="table_row">
                <td width='40%' >31D &nbsp; &nbsp; <span>PLACE OF EXPIRY</span></td>
                <td>GUJARAT PORT, INDIA</td>
              </tr>
               <tr className="table_row">
                <td width='40%' >51D &nbsp; &nbsp; <span>LC ISSUING BANK</span></td>
