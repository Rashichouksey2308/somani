...
function Index(props) {
  ...
  return (
    <div className={`${styles.root}`}>
      {/* <table width="100%" bgColor="#ffffff" style={{marginBottom:'20px'}} cellPadding="0" cellSpacing="0" border="0">
        <tr>
          <td style={{fontFamily:'Times New Roman, Times, serif', paddingTop:'20px', paddingLeft:'20px', paddingRight:'20px', fontSize:'12px', lineHeight:'1.5', color:'#000000'}}>
            ...
            <p>This Sales Contract(“<strong>Contract</strong>”) is made at the place and on the day as set out in Schedule I between the Seller and the Buyer.</p>
          </td>
        </tr>
        <tr>
          <td valign='top' style={{fontFamily:'Times New Roman, Times, serif', fontSize:'12px', lineHeight:'1.5', color:'#000000', paddingLeft:'20px', paddingBottom:'20px', paddingRight:'20px'}}>
            <table width="100%" cellPadding="10" style={{border:'1px solid #000000'}} cellSpacing="0" border="0">
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>Details as per Schedule 1</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>All Taxes and duties, present or future, including variations thereto and other taxes shall be borne and paid by Buyer.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>
                  <ol type="A" style={{paddingLeft:'16px'}}>
                    <li style={{marginBottom:'16px'}}>All the custom clearance formalities, Duties, Taxes and other charges related to import of cargo and custom clearance shall be to Buyer's account and shall be solely the Buyer's responsibility.</li>
                    <li style={{marginBottom:'16px'}}>The Buyer shall pay for entire cargo within 90 days from the date of B/L or 60 days from the date of discharge of vessel at discharge port, whichever is earlier. The Buyer shall make full payment of the material to be lifted through TT remittance. The Seller shall release the part material to Buyer upon receipt of part payment for the part quantity of material to be lifted after obtaining delivery order or Written Release Order from the LC opening bank as per CMA. The delivery order instructions shall be issued for the part material, for which the payment has been made within one banking day. However, Seller will provide first delivery order in Advance as per buyer's request.</li>
                    <li style={{marginBottom:'16px'}}>The material shall be stored at Discharge Port for which the cost of such Rent, Claim, and penalty shall be fully borne by the End User. Upon release of payment for the value of each B/L Quantity Release Order from the Financing Bank shall be sent to the CMA Agent, within one banking day</li>
                    <li style={{marginBottom:'16px'}}>Documents to be provided to Buyer
                      <ol type="1" style={{paddingLeft:'16px', marginTop:'16px'}}>
                        <li style={{marginBottom:'16px'}}>The Seller's Commercial Invoice;</li>
                        <li style={{marginBottom:'16px'}}>Full set of 3/3 originals of Bills of Lading,</li>
                        <li style={{marginBottom:'16px'}}>Certificate of Quality;</li>
                        <li style={{marginBottom:'16px'}}>Certificate of Weight,</li>
                        <li style={{marginBottom:'16px'}}>Certificate of Origin.</li>
                        <li style={{marginBottom:'16px'}}>Copy of Marine Insurance Certificate / Insurance Policy</li>
                      </ol>
                    </li>
                  </ol>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>
                  <ol type="A" style={{paddingLeft:'16px'}}>
                    <li style={{marginBottom:'16px'}}>Marine Insurance: Seller will provide Marine Insurance as received from Shipper.</li>
                    <li style={{marginBottom:'16px'}}>Stock Insurance: The Buyer will arrange insurance for 110% of the cargo value at discharge port, valid at all times covering All Risk including Fire, Burglary and Act of God (AOG). The cargo shall be insured by the Buyer at its own cost for the full value of cargo. The Policy shall be endorsed in favour of the Seller or its nominated Bank. The Beneficiary of the Insurance Claim shall be the Seller or its nominated Bank as per Seller's instructions.</li>
                  </ol>
                </td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>All demurrage/despatch for discharge port to be settled directly between Shipper, Vessel Owner agent and End User with no liability upon the Seller whatsoever</td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>Title to the Goods shall be deemed to have been transferred to the Buyer and the Goods shall be deemed to be sold and delivered to the Buyer only upon receipt by the Seller of the entire contract value. It is clarified that the Seller shall retain lien and the full legal ownership in the Goods, to secure the Buyer's obligation to pay the entire contract value, until receipt by the Seller of the entire contract value.  All risk of loss or damage shall pass to the Buyer as per Incoterms 2020.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>No changes in respect of the contract covered by this agreement shall be valid unless the same is agreed to in writing by both parties herewith specifically stating the same to on amendment to this agreement. Contract is valid if approved by Fax and no mail confirmation will be sent.</td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>Neither Party shall be entitled to assign, transfer or sub-contract its rights under this Agreement in whole or in part without first obtaining the other's consent in writing.</td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>The Parties intend each provision of this Agreement to be severable and distinct from the others. If a provision of this Agreement is held to be illegal, invalid or unenforceable, in whole or in part, the Parties intend that the legality, validity and enforceability of the remainder of this Agreement shall not be affected.</td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>Failure to enforce any condition herein contained shall not operate as a waiver of the condition itself or any subsequent breach thereof.</td>
              </tr>
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000'}}>
                  <ol type="1" style={{paddingLeft:'16px'}}>Each party to this Agreement hereby represents and warrants that:
                    <li style={{marginBottom:'16px'}}>it is a legal entity duly organized and validly existing under the laws of the jurisdiction of its incorporation and has all necessary corporate power, authority and capacity to execute this Agreement and undertake the transactions contemplated herein;</li>
                    <li style={{marginBottom:'16px'}}>the execution and delivery of this Agreement has been duly and validly authorized and constitutes valid and legally binding obligations enforceable in accordance with its terms;</li>
                    <li style={{marginBottom:'16px'}}>the execution, delivery and performance of this Agreement does not and shall not; (i) contravene any provisions of its charter documents; (ii) result in a default, breach or contravention of any conditions or provisions of any agreement to which it is a party or any obligation it is bond by; or (iii) violate any law, order, judgment, injunction, decree, award, rule or regulation applicable to it.</li>
                  </ol>
                </td>
              </tr>
            </table>
                    ...
                    <ol type="1" style={{paddingLeft:'16px'}}>
                      {data?.addComm?.length > 0 &&
                        data?.addComm?.map((val, index) => {
                          return (<li style={{marginBottom:'16px'}} key={index}>{val}</li>)
                        })
                      }
                    </ol>
                  </>
