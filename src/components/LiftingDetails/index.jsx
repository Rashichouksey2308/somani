                                      ...
                                      <tbody>
                                        {val2.modeOfTransportation !== '' && (
                                          <tr className="table_row">
                                            ...
                                            <td>
                                              {val2?.LRorRRDoc?.originalName ? (val2?.LRorRRDoc?.originalName?.toLowerCase().endsWith('.xls') || val2?.LRorRRDoc?.originalName?.toLowerCase().endsWith('.xlsx')) ? <img
                                                src="/static/excel.svg"
                                                className="img-fluid"
                                                alt="Pdf"
                                              /> : (val2?.LRorRRDoc?.originalName?.toLowerCase().endsWith('.doc') || val2?.LRorRRDoc?.originalName?.toLowerCase().endsWith('.docx')) ? < img
                                                src="/static/doc.svg"
                                                className="img-fluid"
                                                alt="Pdf"
                                              /> : <img
                                        ...
                                        <tr className="table_row">
                                          ...
                                          <td>
                                            {val2?.eWayBillDoc?.originalName ? (val2?.eWayBillDoc?.originalName?.toLowerCase().endsWith('.xls') || val2?.eWayBillDoc?.originalName?.toLowerCase().endsWith('.xlsx')) ? <img
                                              src="/static/excel.svg"
                                              className="img-fluid"
                                              alt="Pdf"
                                            /> : (val2?.eWayBillDoc?.originalName?.toLowerCase().endsWith('.doc') || val2?.eWayBillDoc?.originalName?.toLowerCase().endsWith('.docx')) ? < img
                                              src="/static/doc.svg"
                                              className="img-fluid"
                                              alt="Pdf"
                                            /> : <img
