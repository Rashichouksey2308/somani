          ...
          <div className="row">
            ...
            <Form.Group className={`${styles.form_group} col-md-9`}>
              <div className="d-flex justify-content-between">
                ...
                <Form.Control
                  ...
                  type="text"
                  placeholder="Lorem Ipsum Is A Name For A Common Type Of Placeholder Text. Also Known As Filler Or Dummy Text, This Is Simply Text Copy That Serves To Fill A Space Without Actually Saying Anything Meaningful. It's Essentially Nonsense Text That"
                />
                <div className="p-2">
                   
                  <img
            ...
            <div className={`${styles.form_group} col-md-9`}>
              <div
                className={`${styles.comment_para} d-flex justify-content-between`}
              >
                <div className={`${styles.comment} mr-auto`}>
                  Lorem ipsum is a name for a common type of placeholder text.
                </div>
