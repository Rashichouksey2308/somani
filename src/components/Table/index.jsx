                      ...
                      <tr {...headerGroup.getHeaderGroupProps()}>
                        {
                          headerGroup.headers.map((column) => (
                            <th
                              className={`table_heading text-uppercase ${!(data.length && serverSortEnabled && !column.disableSortBy) ? 'cursor-none' : 'cursor-pointer'}`}
                              {...column.getHeaderProps(column.getSortByToggleProps())}
                              onClick={() => (data?.length && serverSortEnabled && !column.disableSortBy) && handleSort(column)}
                            >
                              {column.render('Header').split('_').join(' ')}
                              {data?.length && serverSortEnabled ? !column.disableSortBy
