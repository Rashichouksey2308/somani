        ...
        <tr>
          <td valign="top">
            <table width="100%" bgColor="#ffffff" cellPadding="12" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              <tr>
                <td colSpan={4} height="78" style={{padding:'0 35px', borderBottom:'2px solid #CAD6E6'}}><h3 style={{fontSize:'22px', color:'#3687E8', lineHeight:'27px', fontWeight:'bold'}}>Basic Info</h3></td>
              </tr>
              <tr bgColor="#F7F9FF" height="92">
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Transaction Type</td>
                <td colSpan={3} style={{fontSize:'20px', color:'#111111', lineHeight:'25px'}}>Domestic</td>
              </tr>
              <tr>
                <td width="20%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'37px'}}>Sourcing Channel</td>
                <td width="30%" style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'37px'}}></td>
                <td width="20%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'37px'}}>City</td>
                <td width="30%" style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'37px'}}>Mussoorie</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Buyer</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>CITI BANK</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>State</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>Uttarakhand</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'40px'}}>Type of Business</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'40px'}}>Retailer</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'40px'}}>Industry</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'40px'}}>Retailer</td>
              </tr>
              <tr bgColor="#F7F9FF">
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'29px'}}>Order Value</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'29px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'29px'}}>Commodity</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'29px'}}>value</td>
              </tr>
              <tr bgColor="#F7F9FF">
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Quantity</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Supplier</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr bgColor="#F7F9FF">
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'31px'}}>Country of Origin</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'31px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'31px'}}>Transaction Period</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'31px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'36px'}}>Port of Loading</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'36px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'36px'}}>Port of Discharge</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'36px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Exp. Date of Shipment</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>ETA at Discharge port</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'50px'}}>Laycan from</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'50px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'50px'}}>Laycan to</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'50px'}}>value</td>
              </tr>
            </table>
            <table width="100%" bgColor="#ffffff" cellPadding="12" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              ...
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'27px'}}>No. of Shipments</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'27px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'27px'}}>Port of Destination</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'27px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>No. of Consignees</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Latest Shipment date</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>No. of HS codes</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Oldest shipment date</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'20px'}}>Country of Origins</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'20px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'20px'}}>Commodity to total trade (24 months)</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'20px'}}>value</td>
              </tr>
              <tr>
                <td colSpan={4} style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'25px'}}>Country of Origins</td>
              </tr>
              <tr>
                <td colSpan={4} style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingLeft:'35px', paddingBottom:'53px'}}>Lorem ipsum is a name for a common type of placeholder text. Also known as filler or dummy text, this is simply text copy that serves to fill a space without actually saying anything meaningful.</td>
              </tr>
            </table>
            ...
            <table width="100%" bgColor="#ffffff" cellPadding="8" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              ...
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'31px'}}>Main Banker</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'31px'}}>External Credit Rating</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Open Charges</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Credit Rating Agency</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'61px'}}>Name of Auditor</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'61px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'61px'}}>Change in Auditor</td>
            ...
            <table width="100%" bgColor="#ffffff" cellPadding="8" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              ...
              <tr>
                <td width="30%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'31px'}}>Plant Production Capacity</td>
                <td width="20%" style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
                <td width="30%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'31px'}}>Stock in Transit - Commodity</td>
                <td width="20%" style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Capacity Utilization</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Stock Coverage of Commodity</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Available Stock of Commodity</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Avg Monthly Electricity Bill</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'70px'}}>Daily Consumption of Commodity</td>
                <td colSpan={3} style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'70px'}}>value</td>
              </tr>
            </table>
            <table width="100%" bgColor="#ffffff" cellPadding="15" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              ...
              <tr>
                ...
                <td style={{fontSize:'19px', color:'#111111', lineHeight:'23px', paddingTop:'23px'}}>1,900.00</td>
                <td style={{fontSize:'19px', color:'#111111', lineHeight:'23px', paddingTop:'23px'}}>1,900.00</td>
                <td style={{fontSize:'19px', color:'#111111', lineHeight:'23px', paddingTop:'23px'}}>40%</td>
              </tr>
              <tr>
            ...
            <table width="100%" bgColor="#ffffff" cellPadding="8" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
              ...
              <tr>
                <td width="30%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingTop:'31px'}}>GST Return Filing</td>
                <td width="20%" style={{fontSize:'20px', color:'#EA3F3F', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
                <td width="30%" style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingTop:'31px'}}>NCLT</td>
                <td width="20%" style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingTop:'31px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>EPF Status</td>
                <td style={{fontSize:'20px', color:'#EA3F3F', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>BIFR</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px'}}>Litigation Status</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7'}}>Defaulter Company</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px'}}>value</td>
              </tr>
              <tr>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingLeft:'35px', paddingBottom:'69px'}}>Last Balance Sheet Date</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'69px'}}>value</td>
                <td style={{fontSize:'20px', color:'#111111', lineHeight:'24px', opacity:'0.7', paddingBottom:'69px'}}>Active Directors</td>
                <td style={{fontSize:'20px', color:'#111111', fontWeight:'500', lineHeight:'25px', paddingBottom:'69px'}}>value</td>
              </tr>
            </table>
            <table width="100%" bgColor="#ffffff" cellPadding="8" cellSpacing="0" border="0" style={{border:'1px solid #D2D7E5', borderRadius:'6px', boxShadow:'0 3px 6px #CAD0E2', marginBottom:'26px'}}>
