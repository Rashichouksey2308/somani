              ...
              <table width='100%' bgColor='#D8EAFF' style={{fontFamily:'Arial, Helvetica, sans-serif', marginBottom:'26px', border:'1px solid #D2D7E5', borderRadius:'6px', height:'126px'}} cellPadding='10' cellSpacing='0' border='0'>
                <tr>
                  <td valign='top' align='left' width='33%'>
                    <p style={{fontSize:'20px', color:'#111111', lineHeight:'25px', fontWeight:'500', padding:'10px 0 0 25px'}}>Order ID: <span style={{lineHeight:'24px', fontWeight:'normal', opacity:'0.7'}}>{_get(termsheet, 'data[0].order.orderId', '')}</span></p>
                    <p style={{fontSize:'20px', color:'#111111', lineHeight:'25px', fontWeight:'500', paddingLeft:'25px'}}>Buyer: <span style={{lineHeight:'24px', fontWeight:'normal', opacity:'0.7'}}>{_get(termsheet, 'data[0].company.companyName', '')}</span></p>
                  </td>
                  ...
                  <td valign='top' align='right' width='33%'>
                    <p> <span></span></p>
                    <p style={{fontSize:'20px', color:'#111111', lineHeight:'25px', fontWeight:'500', paddingRight:'25px'}}>Date: <span style={{lineHeight:'24px', fontWeight:'normal', opacity:'0.7'}}>22-02-2022</span></p>
                  </td>
                </tr>
              </table>
            </td>
                    ...
                    <table width='100%' cellPadding='0' cellSpacing='0' border='0'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td align='left'>
                            <p style={{fontSize:'20px', color:'#111111', lineHeight:'24px', fontWeight:'500', padding:'23px 15px 11px 24px', marginBottom:'0'}}>Chrome Ore</p>
                          </td>
                        </tr>
                        <tr>
                          <td align='left' style={{borderRight:'2px solid #cad6e64d'}}>
                          ...
                          <td align='left'>
                            <p style={{fontSize:'20px', color:'#111111', lineHeight:'24px', fontWeight:'500', padding:'11px 15px 11px 24px', marginBottom:'0'}}>5000 MT (± 10%)</p>
                          </td>
                        </tr>
                        <tr>
                          <td align='left' style={{borderRight:'2px solid #cad6e64d'}}>
                          ...
                          <td align='left'>
                            <p style={{fontSize:'20px', color:'#111111', lineHeight:'24px', fontWeight:'500', padding:'11px 15px 38px 24px', marginBottom:'0'}}>USD 192.09/MT</p>
                          </td>
                        </tr>
                      </tbody>
                      <thead>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td align='left'>
                            <p style={{fontSize:'20px', color:'#111111', lineHeight:'24px', fontWeight:'500', padding:'23px 15px 11px 24px', marginBottom:'0'}}>INR</p>
                          </td>
                        </tr>
                        <tr>
                          <td align='left' style={{borderRight:'2px solid #cad6e64d'}}>
                              ...
                              <td align='left' style={{padding:'35px 15px 35px 35px'}}>
                                <ul style={{margin:'0', padding:'0', listStyle:'none'}}>
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="customsClearingCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="wharfaceCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="pollutionCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="royalyAndPenaltyCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="tarpaulinCoverageCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="wheighmentAndWeighmentSurveyCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="draughtSurveyCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="boatingWhileDraughtSurveyCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="hmcCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="securityCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="piotRentalAndStorageCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="bondingOfCargoCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="exBondDocumentationCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="transferOfOwnershipCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="customsBondOfficerOvertimeCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="grabHireCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="craneHireCharges" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="handlingLosses" type="checkbox"/>
                                  ...
                                  <li style={{marginBottom:'24px', display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="waterSprinklingCharges" type="checkbox"/>
                                  ...
                                  <li style={{display:'table'}}>
                                    <input style={{display:'table-cell', width:'20px', height:'20px', verticalAlign:'middle', marginRight:'25px'}} id="others" type="checkbox"/>
