    ...
    <div className={styles.root_container}>
      ...
      <div className={`${styles.term_container} mb-3 mt-3 container-fluid `}>
        ...
        <Row className={`h-50`}>
          ...
          >
            <div>
              <span className={styles.termSub_head}>Buyer:</span>M/s Vishnu
              Chemicals Limited
            </div>
          </Col>
          <Col
          ...
          >
            <div>
              <span className={styles.termSub_head}>Order ID:</span>2FCH6589
            </div>
          </Col>
        </Row>
      </div>
      <Card className={styles.content}>
        <div>
          <Row className={styles.row_head}>
            <Col
              md={4}
              className={`${styles.content_header} d-flex justify-content-center align-content-center`}
            >
          ...
          <Row>
            <Col
              md={4}
              className={`${styles.sub_content} pb-3 pt-4 d-flex justify-content-start align-content-center`}
            >
              <ol>
            ...
            <Col
              md={8}
              className={`${styles.sub_contentValue} pb-3 pt-4 d-flex justify-content-start align-content-center`}
            >
              <ul>
                <li>Chrome Ore</li>
                <li>5000 MT (± 10%)</li>
        ...
        <div>
          ...
          <Row>
            ...
            >
              <ul>
                <li>
                  90 days from the date of arrival of vessel/containers at
                  discharge port or 120 days from the BL date, whichever is
                  earlier, through TT or LC (in the case of LC all Bank charges
                  to be borne and paid by the Buyer). LC Discounting rate
                  Presently @ 4.75% for 90 days usance LC in case of 120 days
                  usance LC Discounting it is subject to actual discounting
                  charges a per the discounting Bank done with proof of charges.
                </li>
              </ul>
            </Col>
          </Row>
        ...
        <div>
          ...
          <Row>
            <Col
              md={12}
              className={`${styles.sub_content_other} pb-3 pt-4 d-flex justify-content-start align-content-center`}
            >
              Below charges are to be borne and paid by the Buyer on actual
              basis,wherever applicable. Indo German International Private
              Limited (IGPL) will provide proof of all expenses to the Buyer.
            </Col>
          </Row>
        </div>
