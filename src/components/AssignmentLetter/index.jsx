    ...
    <div className={`${styles.root}`}>
      ...
      <div className={`${styles.content} card`}>
          <div className={`${styles.cardHeader} border_color card-header d-flex align-items-center justify-content-end p-3 bg-transparent`} data-toggle="collapse" data-target="#assignmentLetter" aria-expanded="true" aria-controls="assignmentLetter">
            <div>Date: <input className='date_field' placeholder="31.08.2021" /></div>                              
...
const sales=()=>{
  return(
     <div className="card-body">
      <p className='text-decoration'>Assignment Letter between: </p>
      <p>Indo International Trading FZCO, Jafza View–18, LOB-180504, Jebel Ali, Dubai, UAE,</p>
      <p>Hira Power and Steels Ltd, 511/1, 512/2, Urla Industrial Complex, Raipur – 493221, C.G., India (“the Buyer”)
      </p>
      <p>and</p>
      <p>ERAMET MARKETING SERVICES, a limited liability company (SAS), registered under the Trade Register of Paris under the number 829 256 049, whose head office is at 10 boulevard de Grenelle – CS 63205 – 75015 Paris – FRANCE (“the Seller or Producer”).
      </p>
      <p>It is hereby agreed that the Seller will accept that the payment for the commodity - approximately 5,000 (+/-10%) MT of Manganese Ore of Gabon Origin (Grade: MMD) (“Goods”) under the Contract No. 21-133 Dated 16.08.2021 (“Sales Contract”) by and between the Seller and Hira Power and Steels Ltd (“Buyer”) is to be made by way of a Letter of Credit (L/C), to be issued on the applicant of Indo International Trading FZCO as per the above-mentioned Contract.  The commodity is for use by Hira Power and Steels Ltd (“the Buyer”) only under the terms and conditions contained within the Sales Contract.
      </p>
