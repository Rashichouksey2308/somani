  ...
  return (
    <div className={`${styles.card} accordion_body container-fluid`}>
      ...
      <div className={`${styles.wrapper} mt-4 card`}>
         <div className={`${styles.cardHeader}  card-header d-flex align-items-center justify-content-between bg-transparent`} data-toggle="collapse" data-target="#marineInsurance" aria-expanded="true" aria-controls="marineInsurance">
        ...
        <div className={`${styles.wrapper} mt-4 card`}>
         <div className={`${styles.cardHeader}  card-header d-flex align-items-center justify-content-between bg-transparent`} data-toggle="collapse" data-target="#storageInsurance" aria-expanded="true" aria-controls="storageInsurance">
        ...
        <div className={`${styles.wrapper} mt-4 card`}>
         <div className={`${styles.cardHeader}  card-header d-flex align-items-center justify-content-between bg-transparent`} data-toggle="collapse" data-target="#uploadDoc" aria-expanded="true" aria-controls="uploadDoc">
        ...
        <div className={styles.table_container}>
                        <table className={`${styles.table} table`} cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr className='table_row'>
                                    ...
                                    <td><img src="/static/pdf.svg" className="img-fluid" alt="Pdf" /></td>
                                    <td className={styles.doc_row}>28-02-2022,5:30 PM</td>
                                    <td> <button className={`${styles.button_upload} btn`}>Upload</button></td>
