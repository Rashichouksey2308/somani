    ...
    >
      <div className="d-flex align-items-center">
        <div className={`${`flex-grow-1`} ${styles.hamburgureContainer}`}>
          <div
            className={`${styles.logo2} ${`flex-grow-1`}`}
            onClick={() => handleOpen()}
          >
            <a href="#">
        ...
        <div className={`${styles.theme} d-flex align-items-center`}>
          <a href="#">
            <img
              ...
              alt="light"
              className={`${styles.light} img-fluid mr-3`}
            />
          </a>
          ...
          <a href="#">
            <img
              src="/static/dark.svg"
              alt="dark"
              className={`${styles.dark} img-fluid ml-3`}
            />
          </a>
        </div>
        ...
        <div className={styles.user_profile}>
          ...
          <div className="dropdown-menu" aria-labelledby="userProfile">
            <a className="dropdown-item">Name: Javanika</a>
            <a className="dropdown-item">Age : 21 Years</a>
            <a
