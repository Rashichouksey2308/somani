                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        ...
                        {convertValue((latestYearData?.equityLiabilities?.otherCurrentLiabilities), unit)?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                        })}
                      ...
                      <td className="text-center">
                        ...
                        {convertValue((previousYearData?.equityLiabilities
                          ?.otherCurrentLiabilities), unit)?.toLocaleString('en-In', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })}
                      ...
                      <td className="text-center">
                        ...
                        {convertValue((lastYearData?.equityLiabilities?.otherCurrentLiabilities), unit)?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2
                        })}
                    ...
                    <tr>
                      ...
                      <td className="text-center border-top">
                        <strong>
                          ...
                          {convertValue((latestYearData?.equityLiabilities?.totalLiabilities), unit)?.toLocaleString('en-In', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })}
                        </strong>
                      ...
                      <td className="text-center border-top">
                        <strong>
                          ...
                          {convertValue((previousYearData?.equityLiabilities?.totalLiabilities), unit)?.toLocaleString('en-In', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })}
                        </strong>
                      ...
                      <td className="text-center border-top">
                        <strong>
                          ...
                          {convertValue((lastYearData?.equityLiabilities?.totalLiabilities), unit)?.toLocaleString('en-In', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })}
                        </strong>
