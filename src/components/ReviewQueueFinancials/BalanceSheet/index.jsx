  ...
  return (
    <>
      <div className={`${styles.card} card border_color border-bottom`}>
        ...
        >
          <div
            className={`${styles.noBorderTable} ${styles.cardBody} p-0 card-body`}
          >
                  ...
                  <thead>
                    <tr>
                      ...
                      <th
                        ...
                        style={{
                          color: `${
                            previousYearData?.date ? '#3687e8' : 'red'
                          }`,
                        }}
                      >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        ...
                        {convertValue(
                          latestYearData?.assets?.tradeRec +
                            latestYearData?.assets?.tradeReceivablesNonCurrent,
                          unit,
                        )?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                      ...
                      <td className="text-center">
                        ...
                        {convertValue(
                          lastYearData?.assets?.tradeRec +
                            lastYearData?.assets?.tradeReceivablesNonCurrent,
                          unit,
                        )?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        ...
                        {convertValue(
                          latestYearData?.assets?.loansCurrent +
                            latestYearData?.assets?.loansNonCurrent,
                          unit,
                        )?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                      ...
                      <td className="text-center">
                        ...
                        {convertValue(
                          previousYearData?.assets?.loansCurrent +
                            previousYearData?.assets?.loansNonCurrent,
                          unit,
                        )?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                      ...
                      <td className="text-center">
                        ...
                        {convertValue(
                          lastYearData?.assets?.loansCurrent +
                            lastYearData?.assets?.loansNonCurrent,
                          unit,
                        )?.toLocaleString('en-In', {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
