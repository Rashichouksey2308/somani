  ...
  return(
    ...
    <p>WHEREAS <GrowInput type="text" className={styles.input_field} /> has appointed <GrowInput type="text" className={styles.input_field} /> …………………………. as its <GrowInput type="text" className={styles.input_field} /> (CHA/Stevedore) for the vessel <GrowInput type="text" className={styles.input_field} /> …………………. at ………….. Port.</p>
     ...
     <p  className="text_sales">IT IS NOW HEREBY AGREED BY AND BETWEEN THE PARTIES AS UNDER:-
                ...
                <br/>
                <br/>
                8. Scanned copy of RR shall be furnished by CHA/Stevedore to <GrowInput type="text" className={styles.input_field} /> as well as ...................... as soon as it is issued after loading. The original RR shall be sent by CHA/Stevedore to ...................... for taking delivery of the rake. The final reconciliation shall be done based on the BL quantity.
                ...
                15. In the event of ...................... does not lift the goods/material within the scheduled period <GrowInput type="text" className={styles.input_field} /> has the right to sell/dispose of the goods/material at the cost of ....................... ...................... shall liable to pay to <GrowInput type="text" className={styles.input_field} /> the loss (if any) incurred by <GrowInput type="text" className={styles.input_field} />. 
