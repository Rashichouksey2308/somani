    ...
    if (window) {
      if (props.preview) {
        ...
        setData({
          ...
          cma: data?.CMA?.name,
          cmaAddress: 'Embassy Chambers, 6th Floor, Plot No. 5, Road No. 3, Khar (West) Mumbai',
  ...
  return (
    <div className={`${styles.cardBody} card-body pt-3`}>
        ...
        <div className={`${styles.inputsContainer2} border_black`}>
          <Row className={`${styles.row} ${styles.last}`}>
            <Col md={7} className={`${styles.left} border_black`}>
              QPA No.: {data.shortseller + '/' + data.shortbuyer + '/' + '2022/001'}
            </Col>
      ...
      <p className="text_sales">
        ...
        <b>{data.buyerAddress}</b> through its Authorised Signatory (hereinafter called <b>{data.shortbuyer}</b>, which
