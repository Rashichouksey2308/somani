        ...
        <div className={`${styles.addressAndDAte} d-flex justify-content-between align-content-center`}>
          <div className={`d-flex`}>
            ...
            <div className={`ml-3 ${styles.noadd}`}>
              {' '}
              INDO INTERNATIONAL TRADING FZCO JAFZA VIEW-18, LOB-180504, JEBEL ALI, DUBAI, U.A.E
            </div>
          </div>
          <div>
        ...
        <div className={styles.body}>
          <p>
            ...
            <span className={styles.bold}>
              LAKE VERMONT MARKETING pTy LTD, LEVEL 7' 12 CREBK STREET, BRISBANE 4000 QUEBSLAND, AUSTRALIA{' '}
            </span>
            and consigned to <span className={styles.bold}>TO ORDER</span> for delivery at the port of
            <span style={styles.bold}>ANY PORT (S) IN INDIA</span> but the bill of lading has not arrived and we,
            EMERGENT INDUSTRIAL SOLUTIONS LIMITED, 49-18-6/1, GROUND FLOOR, LALITHA NAGAR, SAKSHI OFFICE ROAD
            AKKAYYAPALEM, VISAKHAPATNAM, ANDHRA PRADESH - 530016, INDIA , hereby request you to deliver the said cargo
            to EMERGENT INDUSTRIAL SOLUTIONS LIMITED, 49-18-6/1, GROUND FLOOR, LALITHA NAGAR, SAKSHI OFFICE ROAD
            AKKAYYAPALEM, VISAKHAPATNAM, ANDHRA PRADESH - 530016, INDIA or to such party as you believe to be or to
            represent EMERGENT INDUSTRIAL SOLUTIONS LIMITED, 49-18-6/1, GROUND FLOOR, LALITHA NAGAR, SAKSHI OFFICE ROAD
            AKKAYYAPALEM, VISAKHAPATNAM, ANDHRA PRADESH - 530016, INDIA or to be acting on behalf of EMERGENT INDUSTRIAL
            SOLUTIONS LIMITED, 49-18-6/1, GROUND FLOOR, LALITHA NAGAR, SAKSHI OFFICE ROAD AKKAYYAPALEM, VISAKHAPATNAM,
            ANDHRA PRADESH - 530016, INDIA at <span className={styles.bold}> VISAKHAPATNAM PORT (VSPL), INDIA</span>{' '}
          ...
          <div className={`${styles.list}`}>
            ...
            <ol>
              ...
              <li>
                ...
                shall be deemed to be delivery to the party to whom we have requested you to make such deliver{' '}
              </li>
              <li>
              ...
              <li>
                his indemnity shall be governed by and construed in accordance with English law and each and every
