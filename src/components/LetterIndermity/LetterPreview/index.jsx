      ...
      <div className={`${styles.root} card border-0`}>
        <div className={`${styles.content_container}`}>
          ...
          <div className={styles.body}>
            <p>The above cargo was shipped on the above ship by{' '}<span className={styles.bold}>LAKE VERMONT MARKETING PTY LTD, LEVEL 7, 12 CREEK STREET, BRISBANE
              4000 QUEESLAND, AUSTRALIA{' '}</span> and consigned to <span className={styles.bold}>TO ORDER</span> for delivery at the port of{' '} <span className={styles.bold}>ANY PORT (S) IN INDIA </span> but the
            ...
            FLOOR, LALITHA NAGAR, SAKSHI OFFICE ROAD AKKAYYAPALEM,
            VISAKHAPATNAM, ANDHRA PRADESH - 530016, INDIA at<span className={styles.bold}> {' '}VISAKHAPATNAM PORT (VSPL), INDIA </span>{' '} without production of the original bill of lading.</p>
