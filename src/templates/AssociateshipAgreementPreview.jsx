          ...
          <td valign="top" style={{ padding: '0 20px' }}>
            <table width="100%" cellPadding="0" cellSpacing="0" border="0">
              ...
              <tr>
                <td align="justify" style={{paddingBottom:'16px'}}>
                  <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block'}}>
                    Relying upon the representations and information provided by the Associate Buyer in the Request and in the Agreement, <strong>Seller</strong> has agreed to arrange import/ purchase of Goods from the Supplier (Details of Supplier in Schedule-I) and to sell the same to the Associate Buyer on stock &amp; sale basis.
                  </span>
                </td>
              </tr>
              <tr>
                <td align="justify" style={{paddingBottom:'16px'}}>
                  <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block'}}>
                    Whereas, Supplier shall sell the Goods to <strong>{data.seller}</strong>, Zug (hereinafter referred to as <strong>{data.shortseller}</strong>) for onward sale to <strong>Seller</strong> and <strong>Seller</strong> shall, in terms of this Agreement, sell the same to the Associate Buyer.
                  </span>
                </td>
              </tr>
              <tr>
                <td align="justify" style={{paddingBottom:'16px'}}>
                  <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block'}}>
                    Whereas <strong>Seller</strong> shall import Goods for and on behalf of the Associate
                    Buyer, at the sole risk and responsibility of the Associate Buyer and shall store the same under the custody of the Customs House Agent/ Collateral Manager appointed on mutually agreed terms.
                  </span>
                </td>
              </tr>
              <tr>
                ...
                <td align="justify" style={{paddingBottom:'10px'}}>
                  <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingLeft:'25px' }}>
                      ...
                      >
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{marginLeft:'-16px', display:'inline-block'}}>A.&nbsp; </span>The Associate Buyer affirms that the Supplier, Item, specifications, quantities, delivery and all other terms &amp; conditions of sale between {data.shortseller} and the Supplier have been negotiated and firmed up between Associate Buyer and Supplier. The Associate Buyer further undertakes that it has ensured that the Sales Contract to be entered into between {data.shortseller} and the Supplier (“Sale Contract”) is in accordance with the negotiations undertaken by
                            the Associate Buyer and the Supplier.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{marginLeft:'-16px', display:'inline-block'}}>B.&nbsp; </span>The Associate Buyer confirms that he is solely responsible for competitiveness of price, selection of Supplier, quality and quantity of goods and all the risks associated therewith.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', fontWeight:'normal', display:'inline-block'}}>
                        The Associate Buyer shall pay for the Goods imported as per mutually agreed terms mentioned in <strong>Schedule I</strong>. The Associate Buyer shall make full payment of the material to be lifted through RTGS/NEFT. Seller/Custom House Agent (“
                        <strong>CHA</strong>”)/Stevedore shall release the part material to Associate Buyer upon receipt of part payment for the part quantity of material to be lifted after obtaining delivery order or Written Release Order. The delivery order instructions shall be issued for the part material by Seller, for which the payment has been made.
                      </span><br/>
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', fontWeight:'normal', display:'inline-block'}}>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>Ensuring pre-shipment inspection of the goods/items from agencies of international repute as acceptable to Seller.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                        ...
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>Ensuring that quality and quantities of goods shipped are as per LC / Sales Contract / Proforma Invoice at pre-shipment stage and also at port of discharge.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>D. &nbsp; </span>Quantity as per Bill of Lading (“<strong>BL</strong>”) shall be final and binding on the Associate Buyer.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>E. &nbsp; </span>Seller shall not be responsible for <em>any</em> variation in quantity and/or quality of material at the port of loading, port of discharge, during transit to godown/warehouse/plot, while in godown/warehouse/plot and/or till it is delivered to the Associate Buyer. It shall at all times remain the sole responsibility of the Associate Buyer. Associate Buyer shall be solely responsible for any non-supply, short supply or deviation in quality
                            standards/quantity or delay in supply for any reason whatsoever.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>Associate Buyer shall be solely liable and responsible for all consequences arising out of any variation of the item/quality/quantity contracted for &amp; actually shipped. Associate Buyer undertakes to indemnify Seller in this regard. It has been agreed by the Associate Buyer that any claim/liability arising from the Supplier against {data.shortseller}/Seller shall be passed on to the Associate Buyer. If the Supplier agrees upon any compensation on account of any
                            quality deviation, then Seller shall refund the same to the Associate Buyer on receipt of the same.
                          </span>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>The Goods shall be sold by Seller to Associate Buyer on Stock &amp; Sale basis as per delivery terms mentioned in Schedule I. Seller shall file the Bill of Entry in its name and the Associate Buyer shall arrange to clear the cargo at the port.
                            <br />In case the shipment is under Form A-1 the same shall be arranged by the Associate Buyer on or before the customs clearance.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>Seller shall generate e-way bill from the GST portal under its registration for movement of the goods by Rail or Road.</span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>All Duties and taxes shall be paid by the Associate Buyer to CHA/Seller in advance at the time of Custom Clearance. The Associate Buyer shall bear all Handling Charges, Port Charges, Plot Rentals, t etc. to CHA who will take care of the payments to Port and raise bills on “Associate Buyer” for this. The Associate Buyer shall separately take care of the above-mentioned charges and levies and shall make payment of the same to Seller, immediately upon receipt of demand for the same from Seller.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>D. &nbsp; </span>Quantity in Railway Receipt (“<strong>RR</strong>”) /Lorry Receipt (“<strong>LR</strong>”) shall be the final basis for GST billing. The final reconciliation shall be done based on the BL quantity only.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>E. &nbsp; </span>BL quantity shall be considered the final quantity. Any shortage from the BL quantity shall be to the account of Associate Buyer and Seller shall in no way be responsible for the same.
                          </span>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>On Associate Buyer's request, Seller has agreed to appoint Associate Buyer's nominated Stevedoring agent for providing the stevedoring services as specified in the agreement to be entered with Stevedoring Agent.
                          </span><br/>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', paddingBottom:'16px', display:'inline-block'}}>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>The movement of goods from port to warehouse/ plot shall be made by an approved transporter under Transit Insurance Cover, taken by the Associate Buyer in favour of Seller or Seller's Nominated Bank, at the cost and risk of Associate Buyer.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>The Goods shall be cleared and consigned directly to the plot/godown/warehouse (leased in favour of and/or in control of Seller) intended to store the goods in the name of Seller.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>The Associate Buyer shall be held solely liable and responsible for all consequences arising during loading and unloading of Goods at port, movement of goods from port to warehouse/godown/plot and unloading and/or storing of goods at warehouse/godown/plot, and dispatch to the works of the Associate Buyer. All loss in terms of variation in quality and/or quantity of goods shall be borne by Associate Buyer and Seller shall in no way be liable for the same.
                          </span>
                          ...
                          <ul
                            ...
                            <li>
                              <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                                <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>Ocean transportation will be arranged by the Associate Buyer. The freight payment will be made by Seller as directed by the Associate buyers upon receipt of the freight invoice.
                              </span>
                            </li>
                            <li>
                              <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                                <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>Associate Buyer will be solely responsible for the settlement and confirmation of demurrage / dispatch / laytime calculation with shippers/ stevedores/ receivers and Seller will only be responsible for make the freight / demurrage payment as and when remitted by Associate Buyer.
                              </span>
                            </li>
                            <li>
                              <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                                <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>In case of any claim / liability arising out of Charter-party for the vessel chartered then same will be on Associate Buyer's account,
                              </span>
                            </li>
                          </ul>
                        </li>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>The GST Liability and issuance of certificates under the GST Act 2017 as applicable will be the responsibility of Associate Buyer. However, if any other tax liability is levied on this transaction on Seller, the same shall be reimbursed to Seller by Associate Buyer within 7 days of Seller notifying the Associate Buyer of the levy.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>Withholding tax, if any, will be to the account of Associate Buyer. Any excess/refund will be settled within a week's time after getting such advice from Seller.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>Associate Buyer to submit Form 27C (in original) to Seller on monthly basis, in advance. In absence of form 27C Seller will collect the TCS as applicable.
                          </span>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        ...
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>In relation to any dispute arising out of in connection with this Agreement and for the exclusive benefit of Seller, the Associate Buyer hereby irrevocably and unconditionally submits to the jurisdiction of the Courts in Delhi and waives any objection to proceedings with respect to this Agreement in those Courts on the grounds of venue, inconvenient forum of otherwise. However, Seller shall at its sole discretion have the right to file proceedings in other Courts with jurisdiction.
                          </span>
                        </li>
                      </ul>
                    </li>
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>Any dispute or difference, whatsoever, arising between the parties out of, or relating to, or incidental to the construction, meaning, scope, operation or effect of this Agreement; or the validity or the breach thereof, shall be settled by Arbitration by a Sole Arbitrator in accordance with Rules of Arbitration formulated by Indian Council of Arbitration (ICA) and the Associate Buyer agrees to submit to the said forum. The Award made in pursuance thereof shall be binding on the parties. The seat and venue of Arbitration will be New Delhi and the
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px', marginLeft:'-20px'}}>
                        <strong>21.&nbsp; Dispute resolution with {data.shortseller}/Supplier</strong>
                      </span><br/>
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            ...
                            hereunder in this Agreement, any dispute or difference arises between {data.shortseller}/Associate Buyer and Supplier, and due to which any Award/Judgment/decree/Order is passed or otherwise a settlement is reached, the Associate Buyer shall be bound to accept the same and bear the liability, costs, expenses arising there from. In the event, any judicial/ legal proceedings are initiated against the {data.shortseller}/ Seller by the Supplier, the Associate Buyer shall be required to be present and associated at all stages of the proceedings and shall bear the entire expenses of arbitration/litigation and/or of the negotiated settlement. The Associate Buyer shall have no authority or excuse to challenge the same on any ground including that the Associate Buyer has not been consulted therein or that the negotiated settlement is not reasonable or otherwise. Remedies provided under this agreement shall be cumulative and in addition to other remedies provided by law.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>In case there is any dispute, arising out of and/or pursuant to this Agreement, either between Associate Buyer and the Supplier and/ or the Supplier and {data.shortseller}/Seller, the same shall be settled amicably directly by Associate Buyer with the Supplier. In case, such dispute is not settled amicably, any arbitration proceedings and/or other proceedings, which may be initiated by any of the Parties, shall be solely at the cost and risk of Associate Buyer and
                            Seller shall in no manner be liable and responsible for the same.
                          </span>
                        </li>
                      </ul>
                    </li>
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>After conclusion of the deal i.e. receipt of the amounts due to Seller from Associate Buyer/remittance against the import & receipt of RR copies and all other supporting documents related to domestic sale, account maintained by Seller for the Associate Buyer will be settled as per the procedure followed by Seller.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>In case after opening of Letter of credit by {data.shortseller}, the supply contract with Supplier is cancelled for any reason whatsoever, Seller shall be entitled to receive from Associate Buyer all costs incurred by {data.shortseller} and Seller along with its margin/ service charges + applicable GST rate + other costs etc.
                          </span>
                        </li>
                      </ul>
                    </li>
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>Associate Buyer agrees to defend, indemnify, keep indemnified and hold harmless at all times, Seller including, Seller's directors, officers and employees from and/or against all and any claims, losses. damages, demands or costs including but not limited to taxes/duties damages, expenses, demurrage, penalties, liabilities, legal cost, no shipment, delayed shipment, short shipment, claims on account of quality/ quantity/ making/ weight/specifications
                            etc., of whatever nature, arising from but not limited to any action, omission, willful conduct, negligence and/or breach of any term or condition of this Agreement, on part of the Associate Buyer or Supplier or Stevedore. No claim shall be passed on to Seller or {data.shortseller} either by Supplier or Associate Buyer.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>B. &nbsp; </span>All transit or storage losses on any account whatsoever, shall be borne by Associate Buyer and Seller shall in no way be liable for the same.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>C. &nbsp; </span>Associate Buyer shall always abide by the laws of the State and Central Government as applicable/in force from time to time. Seller shall not be responsible for any repercussion on this Agreement on account of any change in Government Acts, Rules and Regulations, or for any failure on the part of the Supplier/Associate Buyer to comply with the same.
                          </span>
                        </li>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>D. &nbsp; </span>That it is made clear that Seller shall not be liable for any loss or damage emanating from the present Agreement and executing the transaction contemplated hereto under any circumstances whatsoever.
                          </span>
                        </li>
                      </ul>
                    </li>
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      <ul type="none" style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', fontWeight:'normal', paddingLeft: '0' }}>
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{display:'inline-block', marginLeft:'-18px'}}>A. &nbsp; </span>In the event any dispute of whatsoever nature arises including but not limited to regarding the time schedule, quality, quantity and demurrage to the same, or difference between the parties, the liability thereto, if any, will be that of Associate Buyer. It is clearly understood between the Parties to the contract that any claim of whatever nature shall be settled between the Associate Buyer and the Supplier directly themselves without recourse to Seller as a party to the dispute.
                          </span>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      ...
                      >
                        <li>
                          <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px'}}>
                            <span style={{ marginLeft: '-14px' }}>i)</span>&nbsp; It is expressly and unconditionally agreed and acknowledged by the and Associate Buyer that the title in the goods/ material shall pass on to the Associate Buyer only in respect of such specific quantity thereof as released from the storage facility by the Stevedore under the Authorized Release Orders after receipt of the price and other payables in respect and actual delivery of the goods having been made to
                            the Associate buyer. The Seller shall continue to be the owner, holding absolute title in the goods/material not so released and delivered to the Associate Buyer in any contingency including but not limited to Associate Buyer even becoming insolvent, and shall be entitled to deal with the goods/material as it may deem fit including disposing them off at the risk, costs and consequences of the Associate Buyer. For the avoidance of doubt, the parties agree and acknowledge that the Goods shall not be in any manner whatsoever be construed to be in
                    ...
                    <li style={{ fontWeight:'bold'}}>
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px', marginLeft:'-20px'}}>
                        <strong>30.&nbsp; Force Majeure</strong>
                      </span><br/>
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', fontWeight:'normal', paddingBottom:'16px'}}>
                      ...
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', fontWeight:'normal', paddingBottom:'16px'}}>
                        “Force Majeure Events” means any event, act or performance which is beyond the control of party, which includes but not limited to, war, invasion, act of foreign enemies, terrorist activities, nationalization, force majeure declared by Shipper/Supplier, breakdown of transport, government acquisition or sanctions, blockage, embargo, strike, lockout, interruption or failure of power source, act of God (including fire, flood, earthquake, storm, hurricane or other natural disaster), pandemic, epidemic, earthquake, civil disobedience, riots, floods..
                      </span>
                    </li>
                    <li style={{ fontWeight:'bold'}}>
                      <span style={{ fontSize: '12px', lineHeight: '18px', color: '#000000', display:'inline-block', paddingBottom:'16px', marginLeft:'-20px'}}>
