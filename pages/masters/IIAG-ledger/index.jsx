...
function Index() {
    ...
    const handleSort = (column) => {
        ...
        dispatch(GetMasterIIAGLedgerQueueRecords(`?page=${currentPage}&limit=${pageLimit}&column=${columnName}&order=${sortOrder}${filterQuery}`));
    };
    useEffect(() => {
        if (window) {
    ...
    const searchView = () => {
        return (
            ...
            <div className='searchResults'>
                <ul>
                    {filteredIIAGLedgerQueue?.data?.ledgerFilteredData?.length > 0 ? filteredIIAGLedgerQueue?.data?.ledgerFilteredData?.map((results, index) => (
    ...
    const handleRoute = (IIAGLedgerMasterData) => {
        ...
        Router.push('/master/IIAG-ledger/id');
    };
    return (
                ...
                <div className={`${styles.filter} d-flex align-items-center`}>
                    <div className={`${styles.head_header} align-items-center`}>
                        <img
                            ...
                            alt="ArrowRight"
                        />
                        <h1 className={styles.heading}><span className='text-uppercase'>IIAG</span> Ledger</h1>
                    </div>
                    <div className={`${styles.filter} d-flex align-items-center flex-grow-1`}>
                        ...
                        <button
                            ...
                            onClick={() => Router.push('/masters/IIAG-ledger/add-IIAG-ledger')}
                        >
                            Add
                        </button>
                    </div>
