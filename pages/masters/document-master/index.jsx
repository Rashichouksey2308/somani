...
function Index() {
  ...
  const [documentTableQueueData, setDocumentTableQueueData] = useState(true);
    ...
    return (
      ...
      searchTerm?.length >= 3 && (
        <div className="searchResults">
          <ul>
            {filteredDocumentMasterQueue?.data?.documentFilteredData?.length > 0 ? (
              filteredDocumentMasterQueue?.data?.documentFilteredData?.map((results, index) => (
                <li
            ...
            <div className={`${styles.filter}`}>
              <div className={`${styles.head_header} align-items-center`}>
                <img
                  ...
                  alt="ArrowRight"
                  onClick={() => {
                    setDocumentTableQueueData(true);
