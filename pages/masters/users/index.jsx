        ...
        <div className={`${styles.filter} d-flex align-items-center`}>
            ...
            <div className={`${styles.search}`}>
              <div className="input-group">
                ...
                <input type="text" className={`${styles.formControl} formControl form-control`} placeholder="Search" />
              </div>
            </div>
            <a className={styles.filterIcon}><img src="/static/filter.svg" className="img-fluid" alt="Filter" /></a>
            <a href="#" className={`${styles.filterList} filterList`}>
              From: 22-02-2022 To: 22-04-2022 <img src="/static/close-b.svg" className="img-fluid" alt="Close"/></a>
            <a href="#" className={`${styles.filterList} filterList`}>
              Raj<img src="/static/close-b.svg" className="img-fluid" alt="Close" /></a>
          ...
          <div className={`${styles.datatable} datatable mt-4`}>
            <div className={`${styles.tableFilter} d-flex justify-content-between`}>
              ...
              <div className={`${styles.pageList} d-flex justify-content-end align-items-center`}>
                ...
                <a href="#" className={`${styles.arrow} ${styles.leftArrow} arrow`}><img src="/static/keyboard_arrow_right-3.svg" alt="arrow left" className="img-fluid"/></a>
                <a href="#" className={`${styles.arrow} ${styles.rightArrow} arrow`}><img src="/static/keyboard_arrow_right-3.svg" alt="arrow right" className="img-fluid"/></a>
              </div>
            </div>
            <table className={`${styles.table} table`} cellpadding="0" cellspacing="0" border="0">
              <thead>
                <tr>
                  <th className={`${styles.table_heading} table_heading`}>USER ID</th>
                  <th className={`${styles.table_heading} table_heading`}>USER NAME</th>
                  <th className={`${styles.table_heading} table_heading`}>CONTACT NUMBER</th>
                  <th className={`${styles.table_heading} table_heading`}>DEPARTMENT</th>
                  <th className={`${styles.table_heading} table_heading`}>CREATION DATE</th>
