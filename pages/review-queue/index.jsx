                      ...
                      >
                        <div className="accordion" id="directorDetails">
                          <div className={`${styles.card} border_color card`}>
                            ...
                            >
                              <div
                                className={`${styles.detailsBox} accordion_Text col-md-2`}
                              >
                              ...
                              <div
                                className={`${styles.detailsBox} accordion_Text ${styles.success} col-md-2`}
                              >
                      ...
                      >
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>
                                Net Block (Land, Building, Plant & Machinery)
                              </td>
                              <td className="text-center">1,900.00</td>
                              <td className="text-center">1,900.00</td>
                              <td className="text-center">1,900.00</td>
              ...
              <div className="tab-pane fade" id="Documents" role="tabpanel">
                <div className={`${styles.card} card border-color mb-4`}>
                  ...
                  <div
                    id="uploadDocuments"
                    className="collapse"
                    aria-labelledby="uploadDocuments"
                    data-parent="#uploadDocuments"
                  >
