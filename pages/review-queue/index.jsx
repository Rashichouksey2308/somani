      ...
      <div className={styles.tabHeader}>
        ...
        <ul className={`${styles.navTabs} nav nav-tabs`}>
          <li className={`${styles.navItem} nav-item`}>
            <a
              className={`${styles.navLink} ${styles.active} nav-link active`}
              data-toggle="tab"
              href="#Profile"
              role="tab"
                ...
                <div className="accordion" id="profileAccordion">
                      ...
                      <div className={`${styles.cardBody} card-body`}>
                        <div className="row">
                          ...
                          <div className="col-md-3">
                            ...
                            <div
                              className={`${styles.value} ${styles.warning}`}
                            >
                              No
                            </div>
                          </div>
                          ...
                          <div className="col-md-3">
                            ...
                            <div className={styles.value}>
                              123, My Building Famous Lane Hyderabad, Telangana
                              - 500072
                            </div>
                          </div>
                          <div className="col-md-3">
                            ...
                            <div className={styles.value}>
                              561, My Building Lane No. 11 Delhi, Delhi - 110001
                            </div>
                          </div>
                          <div className="col-md-3">
                  ...
                  <div className={`${styles.card} card`}>
                    <div
                      ...
                      data-toggle="collapse"
                      data-target="#auditorDetails"
                      aria-expanded="true"
                      aria-controls="auditorDetails"
                    >
                    ...
                    <div
                      id="auditorDetails"
                      className="collapse"
                      aria-labelledby="auditorDetails"
                      data-parent="#profileAccordion"
                    >
                      <div
                  ...
                  <div className={`${styles.card} card`}>
                    ...
                    >
                      <div
                        className={`${styles.directorDetails} ${styles.cardBody} card-body`}
                      >
                          ...
                          <div className={`${styles.card} card`}>
                            ...
                            >
                              <div className={`${styles.detailsBox} col-md-2`}>
                                <label>Name</label>Arv Jay
                              </div>
                              <div className={`${styles.detailsBox} col-md-2`}>
                                <label>PAN</label>AAVPW27766Q{' '}
                                <img
                                  src="/static/approved.svg"
                                  alt="Approved"
                                  className="img-fluid mt-n1"
                              ...
                              <div className={`${styles.detailsBox} col-md-2`}>
                                <label>Email Id</label>email@example.com
                              </div>
                              <div
                                className={`${styles.detailsBox} ${styles.success} col-md-2`}
                              >
                                <label>DIN</label>03148692
                              </div>
                              <div className={`${styles.detailsBox} col-md-2`}>
                                <label>Tenure Start Date</label>17-02-2019
                              </div>
                              <div className={`${styles.detailsBox} col-md-2`}>
                                <label>DSC Status</label>Approved
                              </div>
                            ...
                            >
                              <div className={`${styles.cardBody} card-body`}>
                                <div className="row no-gutters">
                                  ...
                                  >
                                    <label>DIN Status</label>Arv Jay
                                  </div>
                                  <div
                                    className={`${styles.detailsBox} col-md-2`}
                                  >
                                    <label>DSC Registered</label>AAVPW27766Q{' '}
                                    <img
                                      src="/static/approved.svg"
                                      alt="Approved"
                                      className="img-fluid mt-n1"
                                  ...
                                  <div
                                    className={`${styles.detailsBox} ${styles.success} col-md-2`}
                                  >
                                    <label>Designation</label>03148692
                                  </div>
                                  <div
                                    className={`${styles.detailsBox} col-md-2`}
                                  >
                                    <label>Date Of Birth</label>17-02-2019
                                  </div>
                                  <div
                                    className={`${styles.detailsBox} col-md-2`}
                                  >
                                    <label>Contact</label>Approved
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div className={`${styles.card} card`}>
                    ...
                    >
                      <div
                        className={`${styles.graphTable} ${styles.cardBody} card-body`}
                      >
                        ...
                        >
                          <tbody>
                            ...
                            <tr>
                              <td
                                className={`${styles.legends} ${styles.blue} border-top-0 border-bottom-0`}
                              >
                                <span></span>
                              </td>
                              <td
                            ...
                            <tr>
                              <td
                                className={`${styles.legends} ${styles.yellow} border-top-0 border-bottom-0`}
                              >
                                <span></span>
                              </td>
                              <td
                  ...
                  <div className={`${styles.card} card`}>
                    <div
                      className={`${styles.cardHeader} card-header d-flex align-items-center justify-content-between bg-transparent`}
                      data-toggle="collapse"
                      data-target="#creditRatings"
                      aria-expanded="true"
                      aria-controls="creditRatings"
                    >
                    ...
                    >
                      <div
                        className={`${styles.borderTable} ${styles.cardBody} card-body`}
                      >
                        <table
                          className={`${styles.table} table`}
                          cellpadding="0"
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="text-center">-</td>
                              <td className={`${styles.negative} text-center`}>
                                BB+<span>(Negative)</span>
                              </td>
                              <td className="text-center">-</td>
                            </tr>
                            <tr>
                              ...
                              <td className="text-center">-</td>
                              <td className="text-center">-</td>
                              <td className={`${styles.positive} text-center`}>
                                AA+<span>(Positive)</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
            ...
            <div className="container-fluid">
              ...
              <div className="tab-pane fade" id="Compliance" role="tabpanel">
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div className={styles.purple_dot}></div>
                                <div
                                  className={`${styles.compliance_content} ml-1`}
                                >
                                  IBBB
                                </div>
                              </div>
                ...
                <div className={`${styles.card} card`}>
                  ...
                  >
                    <div
                      className={` ${styles.cardBody_litigations} card-body`}
                    >
                      <div
                      ...
                      >
                        ...
                        <div
                          className={`${styles.risk}  d-flex align-items-center ml-2`}
      ...
      <div className={`${styles.card_litigations} card`}>
        <div className={`${styles.card_ligitations_holder}`}>
          <div
            ...
            data-toggle="collapse"
            data-target="#Tribunals"
            aria-expanded="true"
            aria-controls="Tribunals"
          >
            <Row className={`${styles.row}`}>
              ...
              <Col>
                ...
                >
                  ...
                  <span className={styles.lower}>4</span>
                </div>
              </Col>
              <Col>
                <div
...
const table2 = () => {
  return (
    <table
      className={`${styles.table_details} table`}
      cellpadding="0"
      cellspacing="0"
      border="1"
    >
