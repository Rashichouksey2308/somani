  ...
  return(
        ...
        <tr>
          <td style={{fontFamily:'Times New Roman, Times, serif', padding:'20px', fontSize:'12px', lineHeight:'18px', color:'#000000'}}>
            ...
            <p align='center' style={{float:'left', color:'#000000'}}>This Sales Contract("<span style={{fontWeight:'bold'}}>{data.shortseller + "/" + data.shortbuyer + "/" + "2022/001"}</span>") is made at the place and on the day as set out in <strong>Schedule I</strong> between the Seller and the Buyer.</p>
          </td>
        </tr>
        <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>
                  <ol type="A" style={{paddingLeft:'16px', float:'left', display:'block'}}>
                    <li style={{color:'#000000', marginBottom:'10px'}}>All the custom clearance formalities, Duties, Taxes and other charges related to import of cargo and custom clearance shall be to Buyer's account and shall be solely the Buyer's responsibility.</li>
                    <li style={{color:'#000000', marginBottom:'10px'}}>The Buyer shall pay for entire cargo within <em style={{fontStyle:'normal', textDecoration:'underline'}}>90 days</em> from the date of B/L or <em style={{fontStyle:'normal', textDecoration:'underline'}}>60 days</em> from the date of discharge of vessel at discharge port, whichever is earlier. The Buyer shall make full payment of the material to be lifted through TT remittance. The Seller shall release the part material to Buyer upon receipt of part payment for the part quantity of material to be lifted after obtaining delivery order or Written Release Order from the LC opening bank as per CMA. The delivery order instructions shall be issued for the part material, for which the payment has been made within one banking day. However, Seller will provide first delivery order in Advance as per buyer's request.</li>
                    <li style={{color:'#000000', marginBottom:'10px'}}>The material shall be stored at Discharge Port for which the cost of such Rent, Claim, and penalty shall be fully borne by the End User. Upon release of payment for the value of each B/L Quantity Release Order from the Financing Bank shall be sent to the CMA Agent, within one banking day</li>
                    <li style={{marginBottom:'10px'}}>Documents to be provided to Buyer
                      <ol type="1" style={{paddingLeft:'0'}}>
                        ...
                        <li style={{color:'#000000', marginBottom:'10px'}}>Copy of Marine Insurance Certificate / Insurance Policy</li>
                      </ol>
                    </li>
                  </ol>
            ...
            <table width="100%" cellPadding="10" style={{border:'1px solid #000000'}} cellSpacing="0" border="0">
              <tr>
                ...
                <td width="70%" style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>
                  <ol type="A" style={{paddingLeft:'16px'}}>
                    <li style={{marginBottom:'10px', color:'#000000'}}>Marine Insurance: Seller will provide Marine Insurance as received from Shipper.</li>
                    <li style={{marginBottom:'10px', color:'#000000'}}>Stock Insurance: The Buyer will arrange insurance for 110% of the cargo value at discharge port, valid at all times covering All Risk including Fire, Burglary and Act of God (AOG). The cargo shall be insured by the Buyer at its own cost for the full value of cargo. The Policy shall be endorsed in favour of the Seller or its nominated Bank. The Beneficiary of the Insurance Claim shall be the Seller or its nominated Bank as per Seller's instructions.</li>
                  </ol>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>Each party to this Agreement hereby represents and warrants that:
                  <ol type="1" style={{paddingLeft:'16px'}}>
                    <li style={{marginBottom:'10px', color:'#000000'}}>it is a legal entity duly organized and validly existing under the laws of the jurisdiction of its incorporation and has all necessary corporate power, authority and capacity to execute this Agreement and undertake the transactions contemplated herein;</li>
                    <li style={{marginBottom:'10px', color:'#000000'}}>the execution and delivery of this Agreement has been duly and validly authorized and constitutes valid and legally binding obligations enforceable in accordance with its terms;</li>
                    <li style={{marginBottom:'10px', color:'#000000'}}>the execution, delivery and performance of this Agreement does not and shall not; (i) contravene any provisions of its charter documents; (ii) result in a default, breach or contravention of any conditions or provisions of any agreement to which it is a party or any obligation it is bond by; or (iii) violate any law, order, judgment, injunction, decree, award, rule or regulation applicable to it.</li>
                  </ol>
                </td>
              </tr>
            </table>
                          ...
                          data?.spec.map((item, index) => (
                            <tr>
                              {Object.values(item).map((value, id) => (
                                <td style={{borderBottom:'1px solid #d9dde8', color:'#8492a6', borderRight:'1px solid #d9dde8', padding:'5px'}} key={id}>{value}</td>
                              ))}
                            </tr>
                          ))}
                    </table>
