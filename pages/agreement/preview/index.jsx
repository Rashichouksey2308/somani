            ...
            <table width="100%" cellPadding="10" style={{border:'1px solid #000000'}} cellSpacing="0" border="0">
              <tr>
                ...
                <td width="70%" style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>
                  <ol type="A" style={{paddingLeft:'16px', marginBottom:'0'}}>
                    ...
                    <li style={{color:'#000000'}}>Stock Insurance: The Buyer will arrange insurance for 110% of the cargo value at discharge port, valid at all times covering All Risk including Fire, Burglary and Act of God (AOG). The cargo shall be insured by the Buyer at its own cost for the full value of cargo. The Policy shall be endorsed in favour of the Seller or its nominated Bank. The Beneficiary of the Insurance Claim shall be the Seller or its nominated Bank as per Seller's instructions.</li>
                  </ol>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>
                  <ol type="1" style={{paddingLeft:'16px'}}>
                    ...
                    <li style={{marginBottom:'0', color:'#000000', float:'left', width:'100%'}}>The End User and Manufacturer/shipper shall have direct recourse to each other for matters including but not limited to the following:</li>
                  </ol>
              ...
              <tr>
                ...
                <td style={{borderBottom:'1px solid #000000', textAlign:'justify'}}>Each party to this Agreement hereby represents and warrants that:
                  <ol type="1" style={{paddingLeft:'16px', marginTop:'10px', marginBottom:'0'}}>
