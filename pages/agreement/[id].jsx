        ...
        <button className={styles.add_btn}>Add</button>
           ...
           <hr></hr>
            ...
            <h3 className={styles.sub_heading}>Vessel Information</h3>
                ...
                <div className={`${styles.form_group} col-md-4 col-sm-6`} >
                    <input className={`${styles.input_field} input form-control`} required type="text"/> 
                     <label className={`${styles.label_heading} label_heading`}>Free Detention Period At Discharge Port (Days)<strong className="text-danger">*</strong></label>                   
                </div> 
                </div>
            ...
            <table className={`${styles.table} table`} cellpadding="0" cellspacing="0" border="0">
                <thead>
                    ...
                    <tr className='table_row'>
                        <td className={styles.doc_name}>Booking Details<strong className="text-danger">*</strong></td>
                        <td><img src="/static/pdf.svg" className="img-fluid" alt="Pdf" /></td>
                        <td className={styles.doc_row}>28-02-2022,5:30 PM</td>
                        <td> <input className={styles.input_field} type="text" placeholder='Booking_Details.pdf'/>
                    ...
                    <tr className='table_row'>
                        ...
                        <td><img src="/static/pdf.svg" className="img-fluid" alt="Pdf" /></td>
                        <td className={styles.doc_row}>28-02-2022,5:30 PM</td>
                        <td> <input className={styles.input_field} type="text" placeholder='Container_List.pdf'/>
                        <img className={`${styles.close_image} img-fluid `} src="/static/close.svg" alt="close"/> </td>
                    </tr>
