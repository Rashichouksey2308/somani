  ...
  useEffect(() => {
    if (marginData) {
      setInvoiceDataRevised({
        ...
        isConsigneeSameAsBuyer: marginData?.revisedMarginMoney?.invoiceDetail?.isConsigneeSameAsBuyer ? marginData?.revisedMarginMoney?.invoiceDetail?.isConsigneeSameAsBuyer : true,
