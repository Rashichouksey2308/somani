              ...
              <tr>
                <td width="33%" valign="top">
                  <table
                    ...
                    cellPadding="6"
                    cellSpacing="0"
                    border="0" style={{ marginBottom: '40px' }}
                  >
                    <tr>
                      <td
                        style={{
